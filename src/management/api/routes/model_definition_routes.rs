...
#[axum::debug_handler]
pub async fn create_model_definition_handler(
...
#[axum::debug_handler]
pub async fn list_model_definitions_handler(
    State(app_state): State<AppState>,
...
#[axum::debug_handler]
pub async fn get_model_definition_handler(
    State(app_state): State<AppState>,
    Path(id): Path<Uuid>,
...
#[axum::debug_handler]
pub async fn get_model_definition_by_key_handler(
    State(app_state): State<AppState>,
...
#[axum::debug_handler]
pub async fn update_model_definition_handler(
    State(app_state): State<AppState>,
    Path(id): Path<Uuid>,
...
#[axum::debug_handler]
pub async fn delete_model_definition_handler(
    State(app_state): State<AppState>,
    Path(id): Path<Uuid>,
