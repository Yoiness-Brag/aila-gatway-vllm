...
-- Up
CREATE TABLE hub_llmgateway_model_definitions (
    ...
    CONSTRAINT fk_provider
        ...
        REFERENCES hub_llmgateway_providers(id)
...
CREATE UNIQUE INDEX idx_model_definitions_key ON hub_llmgateway_model_definitions(key);

-- Index for faster lookups by provider_id
CREATE INDEX idx_model_definitions_provider_id ON hub_llmgateway_model_definitions(provider_id);
...
BEFORE UPDATE ON hub_llmgateway_model_definitions
FOR EACH ROW
